...
class TestUsers:
    def test_get_client_user_needs_token(self, api_client_user):
    ...
    def test_get_admin_user_can_access_users(self, api_client_admin):
        resp = api_client_admin.get("/users/")
        assert resp.status_code == 200, resp.json()

    def test_client_user_cannot_create_level(self, api_client_user):
    ...
    def test_client_user_cannot_create_equipment(self, api_client_user):
    ...
    def test_admin_user_can_create_level(self, api_client_admin, Level):
    ...
    def test_admin_user_can_create_equipment(self, api_client_admin, Equipment):
    ...
    def test_admin_user_can_create_mechanic(self, api_client_admin, Mechanic):
    ...
    def test_admin_user_can_create_muscle(self, api_client_admin, Muscle):
    ...
    def test_admin_user_can_create_force(self, api_client_admin, Force):
    ...
    def test_admin_user_can_create_category(self, api_client_admin, Category):
